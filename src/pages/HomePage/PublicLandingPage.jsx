          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <motion.button
                ...
                className="px-8 py-3 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-semibold rounded-full transition-all shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:shadow-[0_0_40px_rgba(139,92,246,0.6)]"
              >
                Bắt đầu miễn phí
              </motion.button>
              <motion.button
                ...
                className="px-8 py-3 border-2 border-violet-600 text-white font-semibold rounded-full hover:bg-violet-600/10 transition-all"
              >
                Xem gói dịch vụ
              </motion.button>
            </div>
        ...
        <section id="guide" className="py-24 bg-slate-950 relative">
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              ...
              >
                <span className="text-sm font-bold text-indigo-400 uppercase tracking-widest">Hướng dẫn</span>
              </motion.div>
              ...
              <motion.h2 
                ...
                className="text-3xl md:text-5xl font-bold text-white mb-6"
              >
                Chỉ 3 bước để sinh <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-500">Backend hoàn chỉnh</span>
              </motion.h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {guideSteps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    <div className="absolute -top-8 -left-4 text-7xl font-black text-slate-800 opacity-50 select-none">
                      {step.number}
                    </div>
                    
                    <div className={`relative p-8 rounded-[2rem] border bg-slate-900/40 border-white/5 group-hover:border-indigo-500/30 transition-all duration-300 backdrop-blur-sm h-full flex flex-col`}>
                      <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${step.color} flex items-center justify-center mb-6 shadow-lg shadow-black/20 group-hover:scale-110 transition-transform duration-300`}>
                    ...
                    {index < guideSteps.length - 1 && (
                      <div className="hidden md:block absolute top-1/2 -right-16 w-12 h-0.5 bg-gradient-to-r from-indigo-500 to-transparent" />
                    )}
                  </motion.div>
                );
              })}
            ...
            <div className="mt-20 text-center">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate('/auth?mode=register')}
                className="px-10 py-4 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white font-semibold rounded-full transition-all shadow-[0_0_30px_rgba(99,102,241,0.4)] hover:shadow-[0_0_40px_rgba(99,102,241,0.6)]"
              >
                Bắt đầu ngay
              </motion.button>
            </div>
