  ...
  return (
    <div className="p-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-8">
        ...
        <button onClick={() => toast.success('Báo cáo mock đã sẵn sàng trong localStorage')} className="px-4 py-2 bg-slate-900 border border-white/10 rounded-lg text-sm font-medium text-white hover:bg-white/5 transition-all flex items-center gap-2">
